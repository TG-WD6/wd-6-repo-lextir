...
Conversion time: 13.475 seconds.
...
* Fri Jun 10 2022 05:06:01 GMT-0700 (PDT)
* Source doc: Java Basics
* This document has images: check for >>>>>  gd2md-html alert:  inline image link in generated source and store images to your server. NOTE: Images in exported zip file from Google Docs may not appear in  the same order as they do in your doc. Please check the images!


WARNING:
You have 29 H1 headings. You may want to use the "H1 -> H2" option to demote all headings by one level.
...
![image](images/image19.png)
 verwijst naar de locatie van het object in je computergeheugen. In zijn geheel wordt dit door velen ook wel het **memory address** genoemd.
